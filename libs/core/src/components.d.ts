...
import { UserSatellite } from './workspaces/profile/profile.model';
import {
  FavoriteSatelliteDetail,
  FilterSatellites,
  Satellite,
} from './workspaces/satellites/satellites.model';
...
declare global {
  ...
  interface HTMLKryCardSatelliteElement
    extends Components.KryCardSatellite,
      HTMLStencilElement {}
  var HTMLKryCardSatelliteElement: {
    prototype: HTMLKryCardSatelliteElement;
    new (): HTMLKryCardSatelliteElement;
  };
  interface HTMLKryCreateNewsElement
    extends Components.KryCreateNews,
      HTMLStencilElement {}
  ...
  interface HTMLKryDialogLocationElement
    extends Components.KryDialogLocation,
      HTMLStencilElement {}
  var HTMLKryDialogLocationElement: {
    prototype: HTMLKryDialogLocationElement;
    new (): HTMLKryDialogLocationElement;
  };
  interface HTMLKryDialogLogoutElement
    extends Components.KryDialogLogout,
      HTMLStencilElement {}
  ...
  interface HTMLKryDropdownItemElement
    extends Components.KryDropdownItem,
      HTMLStencilElement {}
  ...
  interface HTMLKrySatellitesElement
    extends Components.KrySatellites,
      HTMLStencilElement {}
  ...
  interface HTMLKrySidebarItemElement
    extends Components.KrySidebarItem,
      HTMLStencilElement {}
  ...
  interface HTMLKryToggleEarthElement
    extends Components.KryToggleEarth,
      HTMLStencilElement {}
...
declare namespace LocalJSX {
  ...
  interface KrySatellites {
    ...
    onKryFavoriteSatellite?: (
      event: KrySatellitesCustomEvent<FavoriteSatelliteDetail>
    ) => void;
    onKryFilter?: (event: KrySatellitesCustomEvent<FilterSatellites>) => void;
    onKryLocation?: (
      event: KrySatellitesCustomEvent<false | GeolocationPosition>
    ) => void;
...
declare module '@stencil/core' {
  export namespace JSX {
    interface IntrinsicElements {
      ...
      'kry-card-news': LocalJSX.KryCardNews &
        JSXBase.HTMLAttributes<HTMLKryCardNewsElement>;
      'kry-card-satellite': LocalJSX.KryCardSatellite &
        JSXBase.HTMLAttributes<HTMLKryCardSatelliteElement>;
      'kry-create-news': LocalJSX.KryCreateNews &
        JSXBase.HTMLAttributes<HTMLKryCreateNewsElement>;
      'kry-dialog': LocalJSX.KryDialog & JSXBase.HTMLAttributes<HTMLKryDialogElement>;
      'kry-dialog-location': LocalJSX.KryDialogLocation &
        JSXBase.HTMLAttributes<HTMLKryDialogLocationElement>;
      'kry-dialog-logout': LocalJSX.KryDialogLogout &
        JSXBase.HTMLAttributes<HTMLKryDialogLogoutElement>;
      'kry-drawer': LocalJSX.KryDrawer & JSXBase.HTMLAttributes<HTMLKryDrawerElement>;
      'kry-dropdown': LocalJSX.KryDropdown &
        JSXBase.HTMLAttributes<HTMLKryDropdownElement>;
      'kry-dropdown-item': LocalJSX.KryDropdownItem &
        JSXBase.HTMLAttributes<HTMLKryDropdownItemElement>;
      ...
      'kry-satellites': LocalJSX.KrySatellites &
        JSXBase.HTMLAttributes<HTMLKrySatellitesElement>;
      ...
      'kry-sidebar-item': LocalJSX.KrySidebarItem &
        JSXBase.HTMLAttributes<HTMLKrySidebarItemElement>;
      'kry-thumb-news': LocalJSX.KryThumbNews &
        JSXBase.HTMLAttributes<HTMLKryThumbNewsElement>;
      'kry-toggle-earth': LocalJSX.KryToggleEarth &
        JSXBase.HTMLAttributes<HTMLKryToggleEarthElement>;
      'kry-track': LocalJSX.KryTrack & JSXBase.HTMLAttributes<HTMLKryTrackElement>;
      'kry-track-view': LocalJSX.KryTrackView &
        JSXBase.HTMLAttributes<HTMLKryTrackViewElement>;
      'kry-view-news': LocalJSX.KryViewNews &
        JSXBase.HTMLAttributes<HTMLKryViewNewsElement>;
    }
  }
}
