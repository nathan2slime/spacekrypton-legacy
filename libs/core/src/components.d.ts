...
declare namespace LocalJSX {
  ...
  interface KryLogin {
    ...
    onKryChangeValue?: (event: KryLoginCustomEvent<KryField>) => void;
  ...
  interface KryLogout {
    ...
    email?: string;
    language?: AppI18nLang;
    onKryCloseDrawer?: (event: KryLogoutCustomEvent<boolean>) => void;
    onKryLogoutApp?: (event: KryLogoutCustomEvent<boolean>) => void;
